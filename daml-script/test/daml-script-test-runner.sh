...
ScriptTest:failingTest FAILURE (com.daml.lf.engine.script.ScriptF$FailedCmd: Command submit failed: INVALID_ARGUMENT: Internal error in LF-DAMLe: Interpretation error: Error: User abort: Assertion failed. Location: com.daml.lf.engine.Engine.interpretLoop. Details : Last location: [DA.Internal.Assert:45], partial transaction:
...
ScriptTest:stackTrace FAILURE (com.daml.lf.engine.script.ScriptF$FailedCmd: Command submit failed: INVALID_ARGUMENT: Internal error in LF-DAMLe: Interpretation error: Error: User abort: Assertion failed. Location: com.daml.lf.engine.Engine.interpretLoop. Details : Last location: [DA.Internal.Assert:45], partial transaction:
