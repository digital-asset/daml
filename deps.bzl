    ...
    if "com_github_grpc_grpc" not in native.existing_rules():
        http_archive(
            ...
            patches = [
                ...
                "@com_github_digital_asset_daml//bazel_tools:grpc-macos.patch",
            ],
            patch_args = ["-p1"],
        )
...
java_import(
    ...
    if "com_github_google_bazel_common" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "b178c50c33bc19fee568a1474faf36f21cb06091e919f5bfce9f1bcb2aefb37e",
            strip_prefix = "bazel-common-11633337c6aaa0bdc7187a5fd9b925093be19e44",
            urls = ["https://github.com/google/bazel-common/archive/11633337c6aaa0bdc7187a5fd9b925093be19e44.zip"],
        )
