...
java_import(
    ...
    jars = glob(["lib/**/*.jar"]),
        ...
        """,
            sha256 = "cfb172aab02838cb8e84a4c21a4a16dd8bf5d4972b89f3efbd410179dfe69e7b",
            strip_prefix = "canton-community-0.27.0",
            urls = ["https://www.canton.io/releases/canton-community-0.27.0.tar.gz"],
        )
