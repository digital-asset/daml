...
def install_java_deps():
    maven_install(
        artifacts = version_specific.get(scala_major_version, []) + [
            ...
            "com.lihaoyi:ammonite-compiler_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-compiler-interface_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-interp-api_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-interp_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-repl_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-runtime_{}:2.5.5".format(scala_version),
            "com.lihaoyi:ammonite-util_{}:2.5.5".format(scala_major_version),
            "com.lihaoyi:ammonite_{}:2.5.5".format(scala_version),
            ...
            "dev.optics:monocle-core_{}:3.1.0".format(scala_major_version),
            "dev.optics:monocle-macro_{}:3.1.0".format(scala_major_version),
