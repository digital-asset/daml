...
def install_java_deps():
    maven_install(
        artifacts = version_specific.get(scala_major_version, []) + [
            ...
            "io.opentelemetry:opentelemetry-api:1.10.0",
            "io.opentelemetry:opentelemetry-context:1.10.0",
            "io.opentelemetry:opentelemetry-sdk-testing:1.10.0",
            "io.opentelemetry:opentelemetry-sdk-trace:1.10.0",
            "io.opentelemetry:opentelemetry-semconv:1.10.0-alpha",
