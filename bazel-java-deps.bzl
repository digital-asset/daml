...
netty_tcnative_version = "2.0.54.Final"
...
def install_java_deps():
    maven_install(
        artifacts = version_specific.get(scala_major_version, []) + [
            ...
            "com.github.pureconfig:pureconfig_{}:0.17.1".format(scala_major_version),
            "com.github.pureconfig:pureconfig-core_{}:0.17.1".format(scala_major_version),
            "com.github.pureconfig:pureconfig-generic_{}:0.17.1".format(scala_major_version),
            "com.github.pureconfig:pureconfig-generic-base_{}:0.17.1".format(scala_major_version),
            maven.artifact("com.github.pureconfig", "pureconfig-macros_2.12", "0.14.1", neverlink = True),
            ...
            "com.lihaoyi:pprint_{}:0.8.0".format(scala_major_version),
            ...
            "io.circe:circe-generic-extras_{}:0.14.2".format(scala_major_version),
            ...
            "com.thesamet.scalapb:scalapb-json4s_{}:0.12.0".format(scala_major_version, scalapb_version),
            ...
            "io.gatling:gatling-commons-shared:{}".format(gatling_version),
            ...
            "io.github.paoloboni:spray-json-derived-codecs_{}:2.3.9".format(scala_major_version),
            ...
            # mockito-* dependencies need to be compatible with mockito-scala
            # see https://github.com/mockito/mockito-scala/blob/release/1.x/project/Dependencies.scala
            ...
            "org.sangria-graphql:sangria-ast_{}:3.4.0".format(scala_major_version),
            "org.sangria-graphql:sangria-core_{}:3.4.0".format(scala_major_version),
            "org.sangria-graphql:sangria-derivation_{}:3.4.0".format(scala_major_version),
            "org.sangria-graphql:sangria-parser_{}:3.4.0".format(scala_major_version),
            "org.sangria-graphql:sangria-spray-json_{}:1.0.3".format(scala_major_version),
            ...
            "org.scalactic:scalactic_{}:3.2.10".format(scala_major_version),
            "org.scalatest:scalatest_{}:3.2.10".format(scala_major_version),
            ...
            "org.wartremover:wartremover_{}:3.0.6".format(scala_version),
