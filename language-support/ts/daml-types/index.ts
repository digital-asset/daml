 ...
 */
export type ContractId<T extends object> = string & { [ContractIdBrand]: object extends T ? (_: never) => object : (_: T) => T }

/**
 * Companion object of the `ContractId` type.
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const ContractId = <T extends object>(_t: Serializable<T>): Serializable<ContractId<T>> => ({
