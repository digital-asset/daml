...
class StakeholdersTest extends FlatSpec with Matchers {
  ...
  they should "be exposed correctly for contracts with only implicit observers" in withClient { client =>
  ...
  they should "be exposed correctly for contracts with only explicit observers" in withClient { client =>
  ...
  they should "be exposed correctly for contracts with both implicit and explicit observers" in withClient { client =>
