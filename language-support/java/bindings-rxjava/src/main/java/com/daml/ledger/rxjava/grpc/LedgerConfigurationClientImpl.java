...
public class LedgerConfigurationClientImpl implements LedgerConfigurationClient {
    ...
    public LedgerConfigurationClientImpl(String ledgerId, Channel channel, ExecutionSequencerFactory sequencerFactory, Optional<String> accessToken) {
        ...
        this.serviceStub = StubHelper.authenticating(LedgerConfigurationServiceGrpc.newStub(channel), accessToken);
    }
    ...
    private Flowable<LedgerConfigurationServiceOuterClass.LedgerConfiguration> getLedgerConfiguration(Optional<String> accessToken) {
        ...
        return ClientPublisherFlowable
                .create(request, StubHelper.authenticating(this.serviceStub, accessToken)::getLedgerConfiguration, sequencerFactory)
