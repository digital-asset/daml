...
/**
 * Represents the {@link SubmitCommandsRequest} together with the contracts that should be
 * considered pending while the submitCommandsRequest are processed.
 */
public class CommandsAndPendingSet {
  ...
  // we use this as "invalid" value to signal that no submitCommandsRequest have been emitted by the
  // bot
  ...
  public CommandsAndPendingSet(
      @NonNull SubmitCommandsRequest submitCommandsRequest,
      @NonNull PMap<Identifier, PSet<String>> contractIdsPendingIfSucceed) {
