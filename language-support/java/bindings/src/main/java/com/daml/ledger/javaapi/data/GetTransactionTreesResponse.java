...
public class GetTransactionTreesResponse {
    ...
    public GetTransactionTreesResponse(List<TransactionTree> transactions) {
    ...
    public TransactionServiceOuterClass.GetTransactionTreesResponse toProto() {
        ArrayList<TransactionOuterClass.TransactionTree> transactionTrees = new ArrayList<>(this.transactions.size());
    ...
    public List<TransactionTree> getTransactions() {
        return transactions;
    }
