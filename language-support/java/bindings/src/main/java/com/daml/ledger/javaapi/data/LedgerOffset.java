...
public abstract class LedgerOffset {
    ...
    public static final class LedgerBegin extends LedgerOffset {
        ...
        @Override public String toString() { return "LedgerOffset.Begin"; }
    }
    ...
    public static final class LedgerEnd extends LedgerOffset {
        ...
        @Override public String toString() { return "LedgerOffset.End"; }
    }
    ...
    final public LedgerOffsetOuterClass.LedgerOffset toProto() {
