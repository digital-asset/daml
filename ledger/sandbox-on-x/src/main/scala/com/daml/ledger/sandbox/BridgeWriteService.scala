...
import com.daml.lf.transaction.{CommittedTransaction, SubmittedTransaction, TransactionNodeStatistics}
    ...
    submission match {
      ...
      case s: Submission.Transaction =>
        Update.TransactionAccepted(
          optCompletionInfo = Some(s.submitterInfo.toCompletionInfo(Some(TransactionNodeStatistics(s.transaction)))),
