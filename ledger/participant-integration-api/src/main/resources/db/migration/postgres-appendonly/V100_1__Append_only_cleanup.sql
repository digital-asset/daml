...
SELECT
    ...
    contract_id,
    template_id,
    NULL::varchar[] as flat_event_witnesses,
    tree_event_witnesses,
    create_argument,
    NULL::varchar[] as create_signatories,
    NULL::varchar[] as create_observers,
    ...
    NULL::varchar[] as exercise_actors,
    NULL::varchar[] as exercise_child_event_ids,
