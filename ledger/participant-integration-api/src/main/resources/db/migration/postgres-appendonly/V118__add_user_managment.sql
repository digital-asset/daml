...
COMMENT ON COLUMN participant_users.created_at IS
    'Up to and including Postgres v13 EXTRACT function returns double type and thus created_at is susceptible to microseconds rounding errors from around year 2250. In contrast, Postgres v14 EXTRACT returns numeric type which effectively has arbitrary precision for this use case';
