...
import com.daml.error.{BaseError, ErrorCategory, ErrorCode, ErrorGroup, ErrorResource, Explanation, Resolution}
...
object LedgerApiErrors extends LedgerApiErrorGroup {
  ...
  object AuthorizationChecks extends ErrorGroup() {
    ...
    object Unauthenticated
      extends ErrorCode(id = "UNAUTHENTICATED", ErrorCategory.AuthInterceptorInvalidAuthenticationCredentials) {
      case class Reject()(implicit loggingContext: ErrorLoggingContext)
    ...
    object PermissionDenied extends ErrorCode(id = "PERMISSION_DENIED", ErrorCategory.InsufficientPermission) {
      case class Reject()(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
  ...
  object CommandValidation extends ErrorGroup {
    ...
    object LedgerIdMismatch
      extends ErrorCode(id = "LEDGER_ID_MISMATCH", ErrorCategory.InvalidGivenCurrentSystemStateResourceMissing) {
      case class Reject(override val cause: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = cause
        )
    }
    ...
    object MissingField extends ErrorCode(id = "MISSING_FIELDS", ErrorCategory.InvalidIndependentOfSystemState) {
      case class Reject(_reason: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
    ...
    @Resolution("Inspect the reason given and correct your application.")
    object InvalidArgument extends ErrorCode(id = "INVALID_ARGUMENT", ErrorCategory.InvalidIndependentOfSystemState) {
      case class Reject(_reason: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
    ...
    @Resolution("Inspect the reason given and correct your application.")
    object InvalidField extends ErrorCode(id = "INVALID_FIELD", ErrorCategory.InvalidIndependentOfSystemState) {
      case class Reject(_reason: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
  ...
  object CommandPreparation extends ErrorGroup {
    ...
    object FailedToDetermineLedgerTime
      extends ErrorCode(id = "FAILED_TO_DETERMINE_LEDGER_TIME", ErrorCategory.ContentionOnSharedResources) {

      case class Reject(_reason: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = s"The participant failed to determine the max ledger time for this command: ${_reason}"
        )
  ...
  object Package extends ErrorGroup() {
    ...
    object AllowedLanguageVersions
      extends ErrorCode(id = "ALLOWED_LANGUAGE_VERSIONS", ErrorCategory.InvalidIndependentOfSystemState) {

      def buildCause(packageId: PackageId,
                     languageVersion: LanguageVersion,
                     allowedLanguageVersions: VersionRange[LanguageVersion]): String =
        LfError.Package.AllowedLanguageVersion(packageId, languageVersion, allowedLanguageVersions).message

      case class Error(packageId: Ref.PackageId,
    ...
    object MissingPackage
      extends ErrorCode(id = "MISSING_PACKAGE", ErrorCategory.InvalidGivenCurrentSystemStateResourceMissing) {
      case class Reject(packageId: PackageId, reference: Reference)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
    ...
    object PackageValidationFailed
      extends ErrorCode(id = "PACKAGE_VALIDATION_FAILED", ErrorCategory.MaliciousOrFaultyBehaviour) {
      case class Reject(err: validation.ValidationError)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = err.pretty
        )
    }
  ...
  object PreprocessingErrors extends ErrorGroup {
    ...
    object PreprocessingFailed
      extends ErrorCode(id = "COMMAND_PREPROCESSING_FAILED", ErrorCategory.InvalidIndependentOfSystemState) {
      case class Reject(err: LfError.Preprocessing.Error)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = err.message
        )
    }
  ...
  object InterpreterErrors extends ErrorGroup {
    ...
    object GenericInterpretationError
      ...
      case class Error(override val cause: String)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = cause
        )
    ...
    // Is INVALID_ARGUMENT, SHOULD BE NOT_EXISTS
      extends ErrorCode(id = "CONTRACT_NOT_ACTIVE", ErrorCategory.InvalidIndependentOfSystemState) {

      case class Reject(override val cause: String, _err: LfInterpretationError.ContractNotActive)(
        implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = cause
        ) {
        override def resources: Seq[(ErrorResource, String)] = Seq((ErrorResource.ContractId, _err.coid.coid))
      }
    ...
    object DuplicateContractKey
      extends ErrorCode(id = "DUPLICATE_CONTRACT_KEY_DURING_INTERPRETATION",
        ErrorCategory.InvalidGivenCurrentSystemStateResourceExists) {
      case class Reject(override val cause: String, _key: GlobalKey)(implicit loggingContext: ErrorLoggingContext)
        extends LoggingTransactionErrorImpl(
          cause = cause
        ) {
        override def resources: Seq[(ErrorResource, String)] = Seq((ErrorResource.ContractKey, _key.toString()))
      }
    }
    ...
    object LookupErrors extends ErrorGroup {
      ...
      @Explanation(
        """This error occurs if the Damle interpreter can not find a referenced contract. This
      ...
      object ContractNotFound
        ...
        case class Reject(override val cause: String, _cid: Value.ContractId)(
          implicit loggingContext: ErrorLoggingContext)
          extends LoggingTransactionErrorImpl(
            cause = cause
          ) {
          override def resources: Seq[(ErrorResource, String)] = Seq((ErrorResource.ContractId, _cid.coid))
        }
    ...
    @Explanation(
      """This error occurs if the Daml transaction fails due to an authorization error.
    ...
    object AuthorizationError
      extends ErrorCode(id = "DAML_AUTHORIZATION_ERROR", ErrorCategory.InvalidIndependentOfSystemState) {
  ...
  object InternalError
    extends ErrorCode(id = "LEDGER_API_INTERNAL_ERROR", ErrorCategory.SystemInternalAssumptionViolated) {

    case class PackageSelfConsistency(err: LfError.Package.SelfConsistency)(
      implicit loggingContext: ErrorLoggingContext)
      extends LoggingTransactionErrorImpl(
        cause = err.message
      )

    case class PackageInternal(err: LfError.Package.Internal)(implicit loggingContext: ErrorLoggingContext)
      extends LoggingTransactionErrorImpl(
        cause = err.message
      )

    case class Preprocessing(err: LfError.Preprocessing.Internal)(implicit loggingContext: ErrorLoggingContext)
      extends LoggingTransactionErrorImpl(
        cause = err.message
      )

    case class Validation(reason: ReplayMismatch)(implicit loggingContext: ErrorLoggingContext)
      extends LoggingTransactionErrorImpl(
        cause = s"Observed un-expected replay mismatch: ${reason}"
      )

    case class Interpretation(where: String, message: String, detailMessage: Option[String])(
      implicit loggingContext: ErrorLoggingContext)
      extends LoggingTransactionErrorImpl(
  ...
  object NonHexOffset extends ErrorCode(id = "NON_HEXADECIMAL_OFFSET", ErrorCategory.InvalidIndependentOfSystemState) {
    case class Error(fieldName: String, offsetValue: String, message: String)(
      implicit val loggingContext: ErrorLoggingContext)
