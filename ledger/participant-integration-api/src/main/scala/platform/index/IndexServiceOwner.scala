...
final class IndexServiceOwner(
  ...
  private def createLedgerReadDao(
    ...
    JdbcLedgerDao.read(
      ...
      acsMaxNumberOfIdsPerIdPage = config.acsIdPageSize,
      acsMaxNumberOfPagesPerIdPagesBuffer = config.acsIdPageBufferSize,
      acsMaxWorkingMemoryInBytesForIdPages = config.acsIdPageWorkingMemoryBytes,
      acsMaxNumberOfParallelIdFetchingQueries = config.acsIdFetchingParallelism,
      acsMaxNumberOfParallelPayloadFetchingQueries = config.acsContractFetchingParallelism,
      acsGlobalMaxNumberOfParallelPayloadQueries = config.acsGlobalParallelism,
