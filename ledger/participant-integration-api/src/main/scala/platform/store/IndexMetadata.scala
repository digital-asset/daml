    ...
    DbSupport
      ...
      .map(dbSupport =>
        JdbcLedgerDao.read(
          ...
          acsMaxNumberOfIdsPerIdPage = 20000,
          acsMaxNumberOfPagesPerIdPagesBuffer = 1,
          acsMaxWorkingMemoryInBytesForIdPages = 100 * 1024 * 1024,
          acsMaxNumberOfParallelIdFetchingQueries = 2,
          acsMaxNumberOfParallelPayloadFetchingQueries = 2,
          acsGlobalMaxNumberOfParallelPayloadQueries = 10,
