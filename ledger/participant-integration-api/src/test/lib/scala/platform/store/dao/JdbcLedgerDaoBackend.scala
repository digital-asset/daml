    ...
    DbSupport
      ...
      .map { dbSupport =>
        JdbcLedgerDao.write(
          ...
          acsMaxNumberOfIdsPerIdPage = acsIdPageSize,
          acsMaxNumberOfPagesPerIdPagesBuffer = 1,
          acsMaxWorkingMemoryInBytesForIdPages = 100 * 1024 * 1024,
          acsMaxNumberOfParallelIdFetchingQueries = acsIdFetchingParallelism,
          acsMaxNumberOfParallelPayloadFetchingQueries = acsContractFetchingParallelism,
          acsGlobalMaxNumberOfParallelPayloadFetchingQueries = acsGlobalParallelism,
