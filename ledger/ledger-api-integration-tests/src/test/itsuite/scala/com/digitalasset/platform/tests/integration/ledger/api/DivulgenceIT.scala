...
class DivulgenceIT
  ...
  private implicit def id(s: String): Ref.Identifier = Ref.Identifier.assertFromString(s)
  ...
  private def createDivulgence1(ctx: LedgerContext): Future[String] =
    create(
      ...
      ValueRecord(None, ImmArray(Some[Ref.Identifier]("div1Party") -> ValueParty("alice")))
    )
  ...
  private def createDivulgence2(ctx: LedgerContext): Future[String] =
    create(
      ...
      ValueRecord(
        None,
        ImmArray(
          Some[Ref.Identifier]("div2Signatory") -> ValueParty("bob"),
          Some[Ref.Identifier]("div2Fetcher") -> ValueParty("alice")))
    )
  ...
  private def divulgeViaFetch(ctx: LedgerContext, div1Cid: String, div2Cid: String): Future[Unit] =
    exercise(
      ...
      ValueRecord(
        None,
        ImmArray(
          Some[Ref.Identifier]("div1ToFetch") -> ValueContractId(AbsoluteContractId(div1Cid))))
    )
  ...
  private def divulgeViaArchive(
    ...
    exercise(
      ...
      ValueRecord(
        None,
        ImmArray(
          Some[Ref.Identifier]("div1ToArchive") -> ValueContractId(AbsoluteContractId(div1Cid))))
    )
