...
trait FieldValidations {
  def errorFactories: ErrorFactories = ErrorFactories
  private val ef = errorFactories
  import ef._
...
object FieldValidations extends FieldValidations {
  def apply(errorFactoriesArg: ErrorFactories): FieldValidations = new FieldValidations {
    override def errorFactories: ErrorFactories = errorFactoriesArg
  }
}
