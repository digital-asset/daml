...
private[kvutils] object TransactionRejections {
  ...
  private object V2 {
    ...
    def externallyDuplicateKeysStatus(
      ...
      GrpcStatus.toProto(
        LedgerApiErrors.CommandRejections.DuplicateContractKey.KVReject().asGrpcStatusFromContext
      )
    ...
    def inconsistentStatus(
      ...
      GrpcStatus.toProto(
        LedgerApiErrors.CommandRejections.Inconsistent
          .Reject(details)
          .asGrpcStatusFromContext
      )
    ...
    def disputedStatus(
      ...
      GrpcStatus.toProto(
        LedgerApiErrors.CommandRejections.Disputed
          .Reject(details)
          .asGrpcStatusFromContext
      )
  }
