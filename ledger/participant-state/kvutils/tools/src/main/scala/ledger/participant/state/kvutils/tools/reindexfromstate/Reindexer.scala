...
import com.daml.ledger.participant.state.kvutils.tools.integritycheck.IntegrityChecker.{CheckFailedException, CommitStrategySupportFactory}
...
object Reindexer {
  def runAndExit[LogResult](args: Array[String], commitStrategySupportFactory: CommitStrategySupportFactory[LogResult]): Unit = {
