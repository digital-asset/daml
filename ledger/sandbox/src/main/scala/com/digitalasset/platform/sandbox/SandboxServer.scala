...
final class SandboxServer(
  ...
  config.profileDir match {
    case None => ()
    case Some(profileDir) => engine.startProfiling(profileDir)
  }
  ...
  private def buildAndStartApiServer(
    ...
    for {
      ...
      logger.withoutContext.info(
        "Initialized sandbox version {} with ledger-id = {}, port = {}, dar file = {}, time mode = {}, ledger = {}, auth-service = {}, contract ids seeding = {}, profile directory = {}",
        BuildInfo.Version,
        ledgerId,
