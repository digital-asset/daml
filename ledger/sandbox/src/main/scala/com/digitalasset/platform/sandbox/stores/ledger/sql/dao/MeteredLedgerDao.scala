...
private class MeteredLedgerDao(ledgerDao: LedgerDao, mm: MetricsManager)
  ...
  override def storeParty(party: Party, displayName: Option[String], externalOffset: Option[ExternalOffset]): Future[PersistenceResponse] =
  ...
  override def uploadLfPackages(
    ...
    mm.timedFuture("uploadLfPackages", ledgerDao.uploadLfPackages(uploadId, packages, externalOffset))
