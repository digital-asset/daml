...
private class JdbcLedgerDao(
  ...
  private def updateActiveContractSet(
    ...
    case LedgerEntry.Transaction(
      ...
      val acsManager = new ActiveLedgerStateManager(new AcsStoreAcc, implicitPartyAllocation)
  ...
  def owner(
    ...
    for {
      ...
      new MeteredLedgerDao(
        JdbcLedgerDao(dbDispatcher, dbType, executionContext, implicitPartyAllocation),
        metrics)
  }
