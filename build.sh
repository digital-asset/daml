...
bazel build //... \
  ...
  --execution_log_json_file "$ARTIFACT_DIRS/logs/build_execution${execution_log_postfix}.log"
...
bazel test //... \
  ...
  --build_event_publish_all_actions \
  --execution_log_json_file "$ARTIFACT_DIRS/logs/test_execution${execution_log_postfix}.log"
