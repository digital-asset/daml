...
hazel_repositories(
  ...
  packages = add_extra_packages(
      ...
      extra =
        ...
        , ("haskell-lsp", {"url": "https://github.com/DavidM-D/haskell-lsp/archive/{}.zip".format(HASKELL_LSP_COMMIT), "sha256": "{}".format(HASKELL_LSP_HASH), "stripPrefix": "haskell-lsp-{}".format(HASKELL_LSP_COMMIT)})
        ]
  ),
  exclude_packages = [
    "arx",
