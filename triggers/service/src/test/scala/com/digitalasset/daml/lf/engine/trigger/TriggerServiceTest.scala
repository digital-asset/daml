...
trait AbstractTriggerServiceTestHelperWithCanton
    extends AsyncFlatSpec
    with HttpCookies
  ...
  protected[this] implicit final class `InClaims syntax`(private val self: ItVerbString) {
    ...
    /** Like `in`, but disables tests that would require the oauth test server
      ...
      */
    def inClaims(testFn: => Future[Assertion])(implicit pos: source.Position): Unit =
      AbstractTriggerServiceTestHelperWithCanton.this.inClaims(self, testFn)
  }
...
// Tests for all trigger service configurations go here
// TODO: rename once Oracle and Postgres migrations are completed
trait AbstractTriggerServiceTestWithCanton extends AbstractTriggerServiceTestHelperWithCanton {
...
// Tests for non-authenticated trigger service configurations go here
// TODO: rename once Oracle and Postgres migrations are completed
trait AbstractTriggerServiceTestNoAuthWithCanton
    extends AbstractTriggerServiceTestWithCanton
    with NoAuthFixture {}
...
// Tests for authenticated trigger service configurations go here
// TODO: rename once Oracle and Postgres migrations are completed
trait AbstractTriggerServiceTestAuthMiddlewareWithCanton
    extends AbstractTriggerServiceTestWithCanton
    with AuthMiddlewareFixture {
...
// TODO: rename once Oracle and Postgres migrations are completed
trait DisableOauthClaimsTestsWithCanton extends AbstractTriggerServiceTestWithCanton {
  protected[this] override final def inClaims(self: HasInIgnore, testFn: => Future[Assertion])(
      implicit pos: source.Position
  ) = {
    import scala.language.reflectiveCalls
