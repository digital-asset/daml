...
CREATE INDEX lapi_configuration_submission_idx ON lapi_configuration_entries USING btree (submission_id);
...
CREATE TABLE lapi_party_records (
    ...
    identity_provider_id    varchar(255)    default null references lapi_identity_provider_config (identity_provider_id)
);
