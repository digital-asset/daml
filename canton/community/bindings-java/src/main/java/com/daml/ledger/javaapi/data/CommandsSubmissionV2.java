 ...
 * <pre/>
 */
public final class CommandsSubmissionV2 {
  ...
  protected CommandsSubmissionV2(
  ...
  public static CommandsSubmissionV2 create(
  ...
  public CommandsSubmissionV2 withWorkflowId(String workflowId) {
    return new CommandsSubmissionV2(
  ...
  public CommandsSubmissionV2 withActAs(String actAs) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withActAs(List<@NonNull String> actAs) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withReadAs(List<@NonNull String> readAs) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withMinLedgerTimeAbs(@NonNull Instant minLedgerTimeAbs) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withMinLedgerTimeRel(@NonNull Duration minLedgerTimeRel) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withDeduplicationDuration(@NonNull Duration deduplicationDuration)
  ...
  public CommandsSubmissionV2 withDeduplicationOffset(@NonNull String deduplicationOffset)
      throws RedundantDeduplicationSpecification {
  ...
  public CommandsSubmissionV2 withCommands(List<@NonNull ? extends HasCommands> commands) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withAccessToken(@NonNull String accessToken) {
    return new CommandsSubmissionV2(
        workflowId,
        applicationId,
        commandId,
  ...
  public CommandsSubmissionV2 withDisclosedContracts(
  ...
  public static CommandsSubmissionV2 fromProto(CommandsOuterClass.Commands commands) {
  ...
  public boolean equals(Object o) {
    ...
    CommandsSubmissionV2 commandsSubmission = (CommandsSubmissionV2) o;
