...
class BlockSequencerTest extends AsyncWordSpec with BaseTest with HasExecutionContext {
  ...
  private class Environment(initial: Option[BlockEphemeralState] = None) extends AutoCloseable {
    ...
    private val domainId = topologyTransactionFactory.domainId
    ...
    topologyStore
      .append(
        ...
        Seq(
          ...
          topologyTransactionFactory.mkDmGov(
  ...
  class FakeBlockSequencerStateManager extends BlockSequencerStateManagerBase {
    ...
    override val maybeLowerSigningTimestampBound: Option[CantonTimestamp] = None
