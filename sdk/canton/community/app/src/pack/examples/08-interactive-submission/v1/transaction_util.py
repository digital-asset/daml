...
def encode_create_node(
    ...
    return (
        ...
        + encode_repeated(sorted(create.signatories), encode_string)
        + encode_repeated(sorted(create.stakeholders), encode_string)
    )
...
def encode_exercise_node(
    ...
    return (
        ...
        + encode_repeated(sorted(exercise.signatories), encode_string)
        + encode_repeated(sorted(exercise.stakeholders), encode_string)
        + encode_repeated(sorted(exercise.acting_parties), encode_string)
        ...
        + encode_repeated(sorted(exercise.choice_observers), encode_string)
...
def encode_fetch_node(fetch, node_id):
    return (
        ...
        + encode_repeated(sorted(fetch.signatories), encode_string)
        + encode_repeated(sorted(fetch.stakeholders), encode_string)
        + encode_repeated(sorted(fetch.acting_parties), encode_string)
    )
...
def encode_metadata(metadata):
    return (
        ...
        + encode_string(metadata.domain_id)
        + encode_proto_optional(
            metadata,
