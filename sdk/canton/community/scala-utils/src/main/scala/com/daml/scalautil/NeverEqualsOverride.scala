...
/** This trait is useful to be mixed in if:
  ...
  *
  * Practical usage: mixing in in DTO ADT top trait, which has case class implementors having Array
  * fields: disables equality semantics, and prevents Wartremover warnings.
  */
