...
import com.digitalasset.canton.domain.sequencing.sequencer.block.bftordering.core.modules.mempool.MempoolModuleMetrics.{
  emitRequestStats,
  emitStateStats,
}
...
import com.digitalasset.canton.domain.sequencing.sequencer.block.bftordering.framework.data.Utils.dequeueN
