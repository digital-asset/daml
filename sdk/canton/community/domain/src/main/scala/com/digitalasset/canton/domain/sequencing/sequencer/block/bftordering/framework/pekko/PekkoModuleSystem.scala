...
package com.digitalasset.canton.domain.sequencing.sequencer.block.bftordering.framework.pekko
...
import com.digitalasset.canton.domain.sequencing.sequencer.block.bftordering.framework.Module.{
  ModuleControl,
...
object PekkoModuleSystem {
  ...
  private def pekkoBehavior[MessageT](
    ...
    Behaviors.setup { context =>
      ...
      var maybeModule: Option[Module[PekkoEnv, MessageT]] = None
      val sendsAwaitingAModule = mutable.Queue[MessageT]()
      Behaviors
        .receiveMessage[ModuleControl[PekkoEnv, MessageT]] {
          case SetBehavior(m: Module[PekkoEnv, MessageT], ready) =>
  ...
  private[bftordering] final case class PekkoActorContext[MessageT](
    ...
    override def setModule[OtherModuleMessageT](
        ...
        module: Module[PekkoEnv, OtherModuleMessageT],
    ): Unit =
    ...
    override def become(module: Module[PekkoEnv, MessageT]): Unit =
  ...
  private[bftordering] final class PekkoModuleSystem(
    ...
    override def setModule[AcceptedMessageT](
        ...
        module: Module[PekkoEnv, AcceptedMessageT],
    ): Unit =
