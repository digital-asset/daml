...
/** @param maxCommandsInFlight
  ...
  *   The deduplication time to use for commands that do not have a deduplication time set. The
  *   deduplication time is also used as the time after which commands time out in the command
  *   client.
  */
