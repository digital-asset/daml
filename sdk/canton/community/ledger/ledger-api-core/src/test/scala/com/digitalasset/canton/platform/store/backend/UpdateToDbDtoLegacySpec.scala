...
import com.digitalasset.canton.platform.store.backend.UpdateToDbDtoLegacy.templateIdWithPackageName
...
class UpdateToDbDtoLegacySpec extends AnyWordSpec with Matchers {

  import TraceContext.Implicits.Empty.*
  import TransactionBuilder.Implicits.*
  import UpdateToDbDtoLegacySpec.*
...
object UpdateToDbDtoLegacySpec {
