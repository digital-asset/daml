...
class DbDtoToStringsForInterningSpec extends AnyFlatSpec with Matchers {
  ...
  private def fixture: List[DbDto] = List(
    ...
    DbDto.EventAssign(
      ...
      driver_metadata = Array.empty,
      source_synchronizer_id = "domain5",
      target_synchronizer_id = "domain6",
      unassign_id = "",
    ...
    DbDto.EventUnassign(
      ...
      event_sequential_id = 0,
      source_synchronizer_id = "domain7",
      target_synchronizer_id = "domain8",
      unassign_id = "",
      reassignment_counter = 0,
