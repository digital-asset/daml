...
/** Class for retrieving dynamic domain parameters.
  ...
  * the `CantonSyncService` as an instance of a [[com.digitalasset.canton.ledger.participant.state.ReadService]]
  * and [[com.digitalasset.canton.ledger.participant.state.WriteService]]).
  *
