...
public class TransactionUtils {
  ...
  /**
   * Constructs a tree described by a transaction.
   *
  ...
  public static <WrappedEvent> List<WrappedEvent> buildTree(
    ...
    List<Integer> rootNodeIds = transaction.getRootNodeIds();
        ...
        .map(
            rootNode ->
                buildWrappedEventTree(
                    rootNode, nodesById, transaction.getEventsById(), createWrappedEvent))
        .toList();
  }
