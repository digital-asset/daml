...
trait Metric[Elem] {
  ...
  /** @return
    *   an updated version of itself and the value observed in this period
    *
  ...
  /** @return
    *   a list of objective violations, where each element is a pair of a violated objective and the
    *   periodic value that violates it the most.
    */
  def violatedPeriodicObjectives: List[(Objective, V)] = Nil

  /** @return
    *   a list of objective violations, where each element is a pair of a violated objective and the
    *   final value that violates it.
    */
