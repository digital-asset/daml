...
The `scenarios` contains actual bootstrap scripts, which need to depend on community/app, while the
drivers are a dependency of the community/app test project.
