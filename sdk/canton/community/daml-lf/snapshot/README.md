...
Build the tool with Bazel:
    ...
    bazel build //canton/community/daml-lf/snapshot:replay-benchmark
...
jmh command line functionality:
     ...
     bazel run //canton/community/daml-lf/snapshot:replay-benchmark --   \
...
A sample ledger entries file can be generated by running:
     ...
     bazel run --sandbox_debug //canton/community/daml-lf/snapshot:generate-snapshots
...
Note: here we assume that a `bazel build //canton/community/daml-lf/snapshot/...` has already been ran to generate the `ReplayBenchmark.dar` Dar file.
...
This profiles the replay of a transaction built from a ledger entries file.
     ...
     bazel run //canton/community/daml-lf/snapshot:replay-profile --     \
