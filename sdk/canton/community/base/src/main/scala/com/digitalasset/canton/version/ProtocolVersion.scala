...
/** A Canton protocol version is a snapshot of how the Canton protocols, that nodes use to communicate, function at a certain point in time
  ...
  *  - Switch the type parameter of the protocol version constant `v<N>` from
  *    [[com.digitalasset.canton.version.ProtocolVersion.Unstable]] to [[com.digitalasset.canton.version.ProtocolVersion.Beta]]
  *  - Remove `v<N>` from [[com.digitalasset.canton.version.ProtocolVersion.unstable]]
...
object ProtocolVersion {
  ...
  private[version] def createBeta(v: Int): ProtocolVersionWithStatus[Beta] =
    createWithStatus[Beta](v)
  ...
  val unstable: NonEmpty[List[ProtocolVersionWithStatus[Unstable]]] =
    NonEmpty.mk(List, ProtocolVersion.dev, ProtocolVersion.v6)
  ...
  lazy val v6: ProtocolVersionWithStatus[Unstable] = ProtocolVersion.createUnstable(6)
  /*
