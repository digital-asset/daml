...
/** Trait for classes that can be serialized to a [[com.google.protobuf.ByteString]].
  ...
  * serialization and deserialization. Hence, [[HasToByteString.toByteString]] does not take any
  * arguments. In contrast, [[HasVersionedToByteString]] is tailored towards another ProtoBuf
