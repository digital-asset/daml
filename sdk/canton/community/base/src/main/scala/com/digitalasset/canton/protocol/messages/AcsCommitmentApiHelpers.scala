  ...
  def toSentCommitmentStateProtoV30: v30.SentCommitmentState =
    this match {
      ...
      case CommitmentPeriodState.Buffered =>
        throw new IllegalStateException("Commitment Period can not be in state Buffered")
    }
...
object CommitmentPeriodState extends {
  case object NotCompared extends CommitmentPeriodState { val toInt = 1 }
  case object Matched extends CommitmentPeriodState { val toInt = 2 }
  case object Mismatched extends CommitmentPeriodState { val toInt = 3 }
  case object Buffered extends CommitmentPeriodState { val toInt = 4 }
  case object Outstanding extends CommitmentPeriodState { val toInt = 5 }

  val states: Map[Int, CommitmentPeriodState] =
