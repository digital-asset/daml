...
object ProtoConverter {
  ...
  def parseNonNegativeInt(i: Int, field: String): ParsingResult[NonNegativeInt] =
    NonNegativeInt.create(i).leftMap(ProtoDeserializationError.InvariantViolation(_).inField(field))
