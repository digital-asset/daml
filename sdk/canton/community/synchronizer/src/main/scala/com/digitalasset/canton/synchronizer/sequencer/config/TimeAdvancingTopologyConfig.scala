...
object TimeAdvancingTopologyConfig {
  ...
  implicit val timeAdvancingTopologyConfigCantonConfigValidator
      : CantonConfigValidator[TimeAdvancingTopologyConfig] =
    CantonConfigValidatorDerivation[TimeAdvancingTopologyConfig]
