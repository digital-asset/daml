...
package com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.unit.modules.availability
...
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.core.modules.availability.*
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.core.modules.availability.AvailabilityModule.quorum
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.core.modules.availability.AvailabilityModuleConfig.EmptyBlockCreationInterval
...
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.core.modules.availability.data.memory.GenericInMemoryAvailabilityStore
...
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.framework.modules.Availability.{
  LocalDissemination,
  LocalOutputFetch,
  RemoteDissemination,
  RemoteOutputFetch,
}
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.framework.modules.Consensus.LocalAvailability.ProposalCreated
import com.digitalasset.canton.synchronizer.sequencing.sequencer.block.bftordering.framework.modules.dependencies.AvailabilityModuleDependencies
  ...
  "it receives OutputFetch.FetchedBlockDataFromStorage and there are missing batches" should {
    "record the missing batches and ask other peer for missing data" in {
      forAll(
        ...
        val outputFetchProtocolState = new MainOutputFetchProtocolState()
        val expectedMessageCell = new AtomicReference[Option[modules.P2PNetworkOut.Message]](None)
