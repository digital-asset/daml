...
/** Generates [[ContractSalt]]s and [[Unicum]]s for contract IDs such that the [[Unicum]] is a cryptographic commitment to the following:
  ...
  *
  * <ol>
  *   <li><strong>If a transaction is added to the virtual synchronizer ledger for a given domain, then the [[Unicum]] is globally unique unless a hash collision occurs.</strong>
  *   <br/>
