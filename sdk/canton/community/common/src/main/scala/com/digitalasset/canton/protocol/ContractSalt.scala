...
/** A blinded cryptographic hash of the information that ensures uniqueness of [[Unicum]]s in
  * Canton. The hash can be used to unblind the [[Unicum]]'s cryptographic commitment to the
  * contract data.
  *
  * @see
