...
/** Filters out any events with log level strictly lower than "LOG_LEVEL_CANTON" and logger name
  * starting with "com.daml" or "com.digitalasset". The property "LOG_LEVEL_CANTON" is first read
  * from java system properties, then from the shell environment and then the default of INFO is
  * taken. (This is consistent with the standard logback behavior.)
  */
