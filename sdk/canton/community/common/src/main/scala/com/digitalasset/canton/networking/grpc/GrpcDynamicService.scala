...
/** Stand up a gRPC service stub which will direct to an instance set dynamically at runtime if
  ...
  *
  * Currently intentionally works with typeless [[io.grpc.ServiceDescriptor]] instances to allow use
  * with stubs generated by [[StaticGrpcServices]]. Validation could be added to ensure full names
  * of services and methods match.
  */
