...
private[transaction] abstract class BaseTopologyMappingChecksOldTest[T <: TopologyMappingChecksOld]
    extends AnyWordSpec
    with BaseTest
  ...
  def checkTransaction(
      checks: TopologyMappingChecksOld,
...
class RequiredTopologyMappingChecksOldTest
    extends BaseTopologyMappingChecksOldTest[RequiredTopologyMappingChecksOld] {
