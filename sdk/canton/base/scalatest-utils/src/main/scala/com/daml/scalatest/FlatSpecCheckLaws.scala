...
/** Integration of Scalatest [[AnyFlatSpec]] with Scalaz law checkers, or any other purely
  * Scalacheck-defined tests, for that matter. Each invocation should go in a separate `behavior of`
