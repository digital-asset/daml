...
canton_version = "3.5.0-snapshot.20260203.17930.0.v8a849517"
    ...
    maven_install(
        artifacts = version_specific.get(scala_major_version, []) + [
            ...
            maven.artifact(
                ...
                version = canton_version,
                # exclude conflicting Scala 3 dependencies, we use ujson_2.13 instead
                exclusions = ["com.lihaoyi:ujson_3"],
            ),
            "com.daml:transcode-codec-proto-scala_3:{}".format(canton_version),
            "com.daml:transcode-daml-lf_3:{}".format(canton_version),
            maven.artifact(
                group = "com.daml",
            ...
            "com.daml:daml-lf-snapshot-proto_{}:{}".format(scala_major_version, canton_version),
            "com.daml:bindings-java:{}".format(canton_version),
            "com.daml:ledger-api-core_{}:{}".format(scala_major_version, canton_version),
            "com.daml:ledger-api-proto:{}".format(canton_version),
            "com.daml:ledger-api-scala_{}:{}".format(scala_major_version, canton_version),
            ...
            "com.daml:logging-entries_{}:{}".format(scala_major_version, canton_version),
            "com.daml:nonempty_{}:{}".format(scala_major_version, canton_version),
            "com.daml:nonempty-cats_{}:{}".format(scala_major_version, canton_version),
            "com.daml:ports_{}:{}".format(scala_major_version, canton_version),
            ...
            "com.daml:nameof_{}:{}".format(scala_major_version, canton_version),
            ...
            "com.daml:daml-grpc-utils_{}:{}".format(scala_major_version, canton_version),
            "com.daml:util-external_{}:{}".format(scala_major_version, canton_version),
            "com.daml:community-base_{}:{}".format(scala_major_version, canton_version),
            "com.daml:community-admin-api_{}:{}".format(scala_major_version, canton_version),
            "com.daml:magnolify-addon_{}:{}".format(scala_major_version, canton_version),
