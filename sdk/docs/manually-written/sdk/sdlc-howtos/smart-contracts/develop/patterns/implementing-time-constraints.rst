...
* or, by calling getTime
    ...
    * the 1 minute value is the default value for the ledger time record time tolerance parameter (a `dynamic synchronizer parameter<https://docs.digitalasset-staging.com/subnet/3.3/howtos/operate/dynamic_param>`_).
