...
* or, by calling getTime
    ...
    * the 1 minute value is the default value for the ledger time record time tolerance parameter (a dynamic synchronizer parameter) - see `Manage dynamic Synchronizer parameters <https://docs.digitalasset-staging.com/subnet/3.3/howtos/operate/dynamic_param>`_
