...
* or, by calling getTime
    ...
    * the 1 minute value is the default value for the ledger time record time tolerance parameter (a :ref:`dynamic synchronizer parameter<synchronizer/howtos/operate/dynamic_params>`).
