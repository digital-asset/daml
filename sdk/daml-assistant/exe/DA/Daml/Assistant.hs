...
argWhitelist = S.fromList
    ...
    , "daml-intro-contracts", "daml-intro-daml-scripts", "daml-intro-data", "daml-intro-choices"
    , "daml-intro-constraints", "daml-intro-parties", "daml-intro-compose", "daml-intro-exceptions"
    , "daml-intro-functional-101", "daml-intro-test"
    , "script-example"
    , "migrate"
    , "init"
    , "build"
