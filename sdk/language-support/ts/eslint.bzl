...
load("@language_support_ts_deps_2x//eslint:index.bzl", _eslint_test = "eslint_test")
...
def eslint_test(name, srcs, tsconfig = ":tsconfig.json", eslintrc = ":.eslintrc.json", data = [], **kwargs):
    ...
    """
    eslint_deps = [
        "@language_support_ts_deps_2x//@typescript-eslint",
        "@language_support_ts_deps_2x//@typescript-eslint/eslint-plugin",
