...
data InvalidInterfaceError
  ...
  | DoesNotMatchEnclosingInterfaceDeclaration
  | NoViewDefined
...
ppInvalidInterfaceError DoesNotMatchEnclosingInterfaceDeclaration = unwords
  [ "The interface of this interface instance does not match the"
  , "enclosing template declaration."
  ]
