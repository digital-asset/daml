    ...
    testGroup
        ...
        (
            ...
            , testUpgradeCheck
                  ...
                  (SucceedWithWarning "warning while type checking template Main.A signatories:\n  The upgraded template A has changed the definition of its signatories..*Expression is structurally different.*upgraded-template-changed")
            , testUpgradeCheck
                  "WarnsWhenTemplateChangesAgreement"
                  (SucceedWithWarning "warning while type checking template Main.A agreement:\n  The upgraded template A has changed the definition of agreement..*Expression is structurally different.*upgraded-template-changed")
            , testUpgradeCheck
                  "WarnsWhenTemplateChangesObservers"
                  (SucceedWithWarning "warning while type checking template Main.A observers:\n  The upgraded template A has changed the definition of its observers..*Expression is structurally different.*upgraded-template-changed")
            , testUpgradeCheck
                  "SucceedsWhenATopLevelEnumChanges"
                  Succeed
            , testUpgradeCheck
                  "WarnsWhenTemplateChangesEnsure"
                  (SucceedWithWarning "warning while type checking template Main.A precondition:\n  The upgraded template A has changed the definition of its precondition..*Expression is structurally different.*upgraded-template-changed")
            , testUpgradeCheck
                  "WarnsWhenTemplateChangesKeyExpression"
                  (SucceedWithWarning "warning while type checking template Main.A key:\n  The upgraded template A has changed the expression for computing its key..*Expression is structurally different.*upgraded-template-changed")
            , testUpgradeCheck
                  "WarnsWhenTemplateChangesKeyMaintainers"
                  (SucceedWithWarning "warning while type checking template Main.A key:\n  The upgraded template A has changed the maintainers for its key..*upgraded-template-changed")
            , testUpgradeCheck
            ...
            , testUpgradeCheck
                  ...
                  (SucceedWithWarning "warning while type checking template Main.A choice C:\n  The upgraded choice C has changed the definition of controllers..*upgraded-choice-changed")
            , testUpgradeCheck
                  "WarnsWhenObserversOfTemplateChoiceAreChanged"
                  (SucceedWithWarning "warning while type checking template Main.A choice C:\n  The upgraded choice C has changed the definition of observers..*upgraded-choice-changed")
            , testUpgradeCheck
