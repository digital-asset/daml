...
decodeUpdate LF2.Update{..} = mayDecode "updateSum" updateSum $ \case
  ...
  LF2.UpdateSumExerciseByKey LF2.Update_ExerciseByKey{..} -> do
    assertSupportsFeature featureContractKeys
  ...
  LF2.UpdateSumUnpackTemplate LF2.Update_UnpackTemplate{..} ->
    fmap EUpdate $ UUnpackTemplate
      <$> mayDecode "update_UnpackTemplateTemplate" update_UnpackTemplateTemplate decodeTypeConId
      <*> mayDecode "update_UnpackTemplateCid" update_UnpackTemplateCid decodeExpr
  LF2.UpdateSumUnpackInterface LF2.Update_UnpackInterface{..} ->
    fmap EUpdate $ UUnpackInterface
      <$> mayDecode "update_UnpackInterfaceInterface" update_UnpackInterfaceInterface decodeTypeConId
      <*> mayDecode "update_UnpackInterfaceCid" update_UnpackInterfaceCid decodeExpr
