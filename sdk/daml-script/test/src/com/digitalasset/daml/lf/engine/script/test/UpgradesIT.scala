...
import com.daml.lf.UpgradeTestUtil
import com.daml.lf.UpgradeTestUtil.TestCase
import com.daml.lf.data.Ref._
import com.daml.lf.data.{FrontStack, ImmArray}
import com.daml.lf.engine.script.ScriptTimeMode
import com.daml.lf.engine.script.test.DarUtil.Dar
...
class UpgradesIT extends AsyncWordSpec with AbstractScriptTest with Inside with Matchers {
  ...
  val testCases: Seq[TestCase] =
    UpgradeTestUtil.getTestCases(testFileDir).filter(_.name == "DataChanges")
