...
class UpgradesITSmall extends UpgradesIT(numParticipants = 2, testCaseFilter = _.name != "SubViews")
class UpgradesITSLarge
    extends UpgradesIT(numParticipants = 5, testCaseFilter = _.name == "SubViews")
