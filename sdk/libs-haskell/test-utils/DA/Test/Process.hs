...
callProcessForStderrIn :: FilePath -> String -> IO String
callProcessForStderrIn path cmd =
  snd <$> run (ShouldSucceed False) (shell cmd) { cwd = Just path }
