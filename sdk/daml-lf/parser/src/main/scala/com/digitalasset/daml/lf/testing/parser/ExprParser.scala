...
private[parser] class ExprParser[P](parserParameters: ParserParameters[P]) {
  ...
  private val builtinFunctions = Map(
    ...
    "KECCAK256_BYTES" -> BKECCAK256Bytes,
    ...
    "TEXT_TO_BYTES" -> BTextToBytes,
    "BYTES_TO_TEXT" -> BBytesToText,
    "INT64_TO_BYTES" -> BInt64ToBytes,
    "BYTES_TO_INT64" -> BBytesToInt64,
    "APPEND_BYTES" -> BAppendBytes,
