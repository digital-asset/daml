...
private[daml] sealed class StablePackagesImpl(
  ...
  override lazy val FailureStatus: Ref.TypeConName = DA_Internal_Fail.assertIdentifier("FailureStatus")
  ...
  private lazy val DA_Internal_Fail = allPackagesByName("DA.Internal.Fail")
