...
import com.daml.lf.data.{Decimal, FrontStack, ImmArray, Numeric, Ref, SortedLookupList, Time}
...
class HashSpec extends AnyWordSpec with Matchers with TableDrivenPropertyChecks {
  ...
  "KeyHasher" should {
    ...
    "be stable" in {
      val hash = "d813c4acad3267e385f844c7c0e912d5867ab3c8ee64a62f6a426ea266fd14b3"
      val value = complexRecordT.inj(complexRecordV)
      val name = defRef("module", "name")
