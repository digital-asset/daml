...
import com.digitalasset.daml.lf.transaction.{GlobalKey, GlobalKeyWithMaintainers, Node, NodeId, VersionedTransaction}
...
class NodeHashSpec extends AnyWordSpec with Matchers {
  ...
  private val createNode = Node.Create(
    coid = ContractId.V1.assertFromString("0007e7b5534931dfca8e1b485c105bae4e10808bd13ddc8e897f258015f9d921c5"),
    packageName = packageName0,
    packageVersion = None,
    templateId = defRef("module", "name"),
    arg = VA.text.inj("hello"),
    agreementText = "NOT_PART_OF_HASH",
    signatories = Set[Party](Ref.Party.assertFromString("alice"), Ref.Party.assertFromString("bob")),
    stakeholders = Set[Party](Ref.Party.assertFromString("alice"), Ref.Party.assertFromString("charlie")),
  ...
  private val fetchNode = Node.Fetch(
    ...
    packageName = packageName0,
    templateId = defRef("module", "name"),
    actingParties = Set[Party](Ref.Party.assertFromString("alice"), Ref.Party.assertFromString("bob")),
  ...
  private val exerciseNode = Node.Exercise(
    targetCoid = ContractId.V1.assertFromString("0007e7b5534931dfca8e1b485c105bae4e10808bd13ddc8e897f258015f9d921c5"),
    packageName = packageName0,
    templateId = defRef("module", "name"),
    interfaceId = Some(defRef("interface_module", "interface_name")),
  ...
  private val lookupNode = Node.LookupByKey(
    ...
    templateId = defRef("module", "name"),
    key = globalKey,
    result = Some(ContractId.V1.assertFromString("0007e7b5534931dfca8e1b485c105bae4e10808bd13ddc8e897f258015f9d921c5")),
    version = LanguageVersion.v2_1,
  )
  ...
  private val lookupNode2 = Node.LookupByKey(
    ...
    templateId = defRef("module", "name"),
    key = globalKey2,
    result = Some(ContractId.V1.assertFromString("0059b59ad7a6b6066e77b91ced54b8282f0e24e7089944685cb8f22f32fcbc4e1b")),
    version = LanguageVersion.v2_1,
  )
  ...
  "CreateNodeBuilder V1" should {
    val defaultHash = Hash.fromString("bada68ce6be10bbb6eb8ea3769fdaa6aa828022e219f2f83a54458b7f46c9c32").getOrElse(fail("Invalid hash"))
    ...
    "not produce collision in contractId" in {
      Hash.hashNode(createNode.copy(
        coid = ContractId.V1.assertFromString("0059b59ad7a6b6066e77b91ced54b8282f0e24e7089944685cb8f22f32fcbc4e1b")
      )) should !==(defaultHash)
    }
  ...
  "FetchNodeBuilder V1" should {
    val defaultHash = Hash.fromString("2d94f4f8a53f1dd0531e1095c677916442e32430a3fc5614069e57f695fcf8a8").getOrElse(fail("Invalid hash"))
  ...
  "ExerciseNodeBuilder V1" should {
    val defaultHash = Hash.fromString("625b53d3ac0c83160759b5f462433aa58c50a93ff4c1af909124bafa61ab7931").getOrElse(fail("Invalid hash"))
    ...
    "not hash NodeIds" in {
      Hash.hashNode(exerciseNode
        ...
        subNodes.map {
          case (nodeId, node) => NodeId(nodeId.index + 1) -> node
        },
      ) shouldBe defaultHash
    }

    "not produce collision in contractId" in {
      hashExerciseNode(exerciseNode.copy(
        targetCoid = ContractId.V1.assertFromString("0059b59ad7a6b6066e77b91ced54b8282f0e24e7089944685cb8f22f32fcbc4e1b")
      )) should !==(defaultHash)
    }
  ...
  "LookupUpByKeyNodeBuilder V1" should {
    val defaultHash = Hash.fromString("6a8fffe7a3e178d7253e1e91a6f5f483ae5e3e35c31eb74caa4d71f8d2c6649a").getOrElse(fail("Invalid hash"))
  ...
  "RollbackNode Builder V1" should {
    val defaultHash = Hash.fromString("0d6628eb5db957ea614a19b0cfc0f0c6dd57b53b4c2ae48c5e978df9d230e706").getOrElse(fail("Invalid hash"))
    ...
    "not produce collision in children" in {
      hashRollbackNode(rollbackNode.copy(
  ...
  "TransactionBuilder" should {
    ...
    val defaultHash = Hash.fromString("43cbd72afc15db4c35f88a3abcc5812f228b403ef6d9a312dd8e0bce564d54aa").getOrElse(fail("Invalid hash"))
    ...
    "throw if some nodes are missing" in {
      an[IncompleteTransactionTree] shouldBe thrownBy {
        Hash.hashTransaction(VersionedTransaction(
          version = LanguageVersion.v2_1,
          roots = roots,
          nodes = nodes.drop(2),
        ))
