...
class ValidationSpec extends AnyFreeSpec with Matchers with TableDrivenPropertyChecks {
  ...
  private val samKWM1 =
    GlobalKeyWithMaintainers.assertBuild(samTemplateId1, samValue1, null, samParties1, somePkgName)
  private val samKWM2 =
    GlobalKeyWithMaintainers.assertBuild(samTemplateId1, samValue1, null, samParties2, somePkgName)
  private val samKWM3 =
    GlobalKeyWithMaintainers.assertBuild(samTemplateId2, samValue2, null, samParties1, somePkgName)
