...
private[speedy] sealed abstract class SBuiltinPure(arity: Int) extends SBuiltinFun(arity) {
  ...
  /** Pure builtins do not modify the machine state and do not ask questions of the ledger. As a result, pure builtin
    ...
    *
    * @param costModel cost model used by this machine instance
...
private[lf] object SBuiltinFun {
  ...
  final case object SBShiftNumeric extends SBuiltinPure(2) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BShiftNumeric.cost(outputScale, x))
  ...
  final case object SBExplodeText extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BExplodeText.cost(arg0))
  ...
  final case object SBImplodeText extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.costAware(costModel.BImplodeText)
  ...
  final case object SBAppendText extends SBuiltinPure(2) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BAppendText.cost(arg0, arg1))
  ...
  final case object SBPartyToQuotedText extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BPartyToText.cost(arg0))
  ...
  final case object SBTextToNumeric extends SBuiltinPure(2) {
    ...
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BTextToNumeric.cost(scale, string))
  ...
  final case object SBSHA256Text extends SBuiltinPure(1) {
    override private[speedy] def executePure(costModel: CostModel, args: Array[SValue]): SText =
  ...
  final case object SBMapToList extends SBuiltinPure(1) {
    ...
    override private[speedy] def executePure(
      ...
      if (arg0.isTextMap) {
        costModel.update(costModel.BTextMapToList.cost(arg0))
      } else {
        costModel.update(costModel.BGenMapToList.cost(arg0))
      }
  ...
  final case object SBMapInsert extends SBuiltinPure(3) {
    override private[speedy] def executePure(
      ...
      if (arg2.isTextMap) {
        costModel.update(costModel.BTextMapInsert.cost(arg0, arg1, arg2))
      } else {
        costModel.update(costModel.BGenMapInsert.cost(arg0, arg1, arg2))
      }
  ...
  final case object SBMapLookup extends SBuiltinPure(2) {
    override private[speedy] def executePure(
      ...
      if (arg1.isTextMap) {
        costModel.update(costModel.BTextMapLookup.cost(arg0, arg1))
      } else {
        costModel.update(costModel.BGenMapLookup.cost(arg0, arg1))
      }
  ...
  final case object SBMapDelete extends SBuiltinPure(2) {
    override private[speedy] def executePure(
      ...
      if (arg1.isTextMap) {
        costModel.update(costModel.BTextMapDelete.cost(arg0, arg1))
      } else {
        costModel.update(costModel.BGenMapDelete.cost(arg0, arg1))
      }
  ...
  final case object SBMapKeys extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BGenMapKeys.cost(arg0))
  ...
  final case object SBMapValues extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BGenMapValues.cost(arg0))
  ...
  final case object SBMapSize extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      if (arg0.isTextMap) {
        costModel.update(costModel.BTextMapSize.cost(arg0))
      } else {
        costModel.update(costModel.BGenMapSize.cost(arg0))
      }
  ...
  final case object SBDateToUnixDays extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BDateToUnixDays.cost(date))
  ...
  final case object SBTimestampToUnixMicroseconds extends SBuiltinPure(1) {
    override private[speedy] def executePure(
      ...
      costModel.update(costModel.BTimestampToUnixMicroseconds.cost(arg0))
  ...
  final case object SBLess extends SBCompare(_ < 0) {
    override def predCost(costModel: CostModel, arg0: SValue, arg1: SValue): CostModel.Cost =
      costModel.BLess.cost(arg0, arg1)
  }
  final case object SBLessEq extends SBCompare(_ <= 0) {
    override def predCost(costModel: CostModel, arg0: SValue, arg1: SValue): CostModel.Cost =
      costModel.BLessEq.cost(arg0, arg1)
  }
  final case object SBGreater extends SBCompare(_ > 0) {
    override def predCost(costModel: CostModel, arg0: SValue, arg1: SValue): CostModel.Cost =
      costModel.BGreater.cost(arg0, arg1)
  }
  final case object SBGreaterEq extends SBCompare(_ >= 0) {
    override def predCost(costModel: CostModel, arg0: SValue, arg1: SValue): CostModel.Cost =
      costModel.BGreaterEq.cost(arg0, arg1)
  }
