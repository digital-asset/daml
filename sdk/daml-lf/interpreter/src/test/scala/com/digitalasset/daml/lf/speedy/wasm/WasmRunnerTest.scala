...
class WasmRunnerTest
  ...
  private val languages: Map[String, String] = Map("rust" -> "rs", "python" -> "py")
  ...
  for (target <- Seq("python")) { // languages.keySet) {
