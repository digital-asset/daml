...
private[daml] class EncodeV2(minorLanguageVersion: LV.Minor) {
  ...
  private[this] class PackageEncoder(selfPkgId: PackageId) {
    ...
    // (https://github.com/digital-asset/daml/pull/21645) sharing of expressions
    // in damlc, we have it here because its simpler, the decoder doesn't care,
    // and we only use this encoder for testing.
