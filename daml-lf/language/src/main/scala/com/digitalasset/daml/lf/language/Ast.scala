...
object Ast {
  ...
  final class GenDefInterfaceCompanion[E] {
    ...
    def build(
      ...
      GenDefInterface(requiresSet, param, fixedChoiceMap, fieldMap, methodMap, precond)
    }
    ...
    def apply(
      ...
      GenDefInterface(requires, param, fixedChoices, fields, methods, precond)
    ...
    def unapply(arg: GenDefInterface[E]): Some[
      ...
      Some((arg.requires, arg.param, arg.fixedChoices, arg.fields, arg.methods, arg.precond))
  }
