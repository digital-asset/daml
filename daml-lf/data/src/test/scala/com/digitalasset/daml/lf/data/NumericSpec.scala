...
class NumericSpec
  ...
  "fromBigDecimal" should {
    ...
    "fail on too Large inputs" in {
      ...
      forEvery(testCases) { (scale, bigDec) =>
        Numeric.fromBigDecimal(scale, bigDec) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.add" should {
    ...
    "return an error in case of overflow" in {
      ...
      add("1.0", "1.0") shouldBe Symbol("right")

      forEvery(testCases) { (x, y) =>
        add(x, y) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.subtract" should {
    ...
    "throw an exception in case of overflow" in {
      ...
      subtract("1.0", "1.0") shouldBe Symbol("right")

      forEvery(testCases) { (x, y) =>
        subtract(x, y) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.multiply" should {
    ...
    "return an error in case of overflow" in {
      ...
      multiply(0, "10000000000000000000.", "1000000000000000000.") shouldBe Symbol("right")

      forEvery(testCases) { (scale, x, y) =>
        multiply(scale, x, y) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.divide" should {
    ...
    "return an error in case of overflow" in {
      ...
      divide(10, "100000000000000000.0000000000", "0.0000000001") shouldBe Symbol("right")

      forEvery(testCases) { (scale, x, y) =>
        divide(scale, x, y) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.round" should {
    ...
    "return an error in case of overflow" in {
      ...
      forEvery(testCases) { (s, x) =>
        round(s, x) shouldBe Symbol("left")
      }
    }
  ...
  "Numeric.fromString" should {
    ...
    "reject improperly formatted string" in {
      ...
      fromString("1.0") shouldBe Symbol("right")
      forEvery(testCases) { x =>
        fromString(x) shouldBe Symbol("left")
      }
    }
