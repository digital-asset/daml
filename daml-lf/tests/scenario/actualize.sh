...
bazel build //daml-foundations/daml-tools/damlc-app:damlc-app
../../../bazel-bin/daml-foundations/daml-tools/damlc-app/damlc-app package --debug --target 1.dev $TESTMAIN main -o $TESTDAR
