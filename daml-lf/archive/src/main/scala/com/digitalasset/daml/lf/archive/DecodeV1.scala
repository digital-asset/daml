...
private[lf] object DecodeV1 {
  ...
  val builtinFunctionInfos: List[BuiltinFunctionInfo] = {
    ...
    List(
      ...
      BuiltinFunctionInfo(TEXTMAP_EMPTY, BMapEmpty, minVersion = textMap),
      BuiltinFunctionInfo(TEXTMAP_INSERT, BMapInsert, minVersion = textMap),
      BuiltinFunctionInfo(TEXTMAP_LOOKUP, BMapLookup, minVersion = textMap),
      BuiltinFunctionInfo(TEXTMAP_DELETE, BMapDelete, minVersion = textMap),
      BuiltinFunctionInfo(TEXTMAP_TO_LIST, BMapToList, minVersion = textMap),
      BuiltinFunctionInfo(TEXTMAP_SIZE, BMapSize, minVersion = textMap),
