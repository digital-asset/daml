...
private[lf] object DecodeV1 {
  ...
  val builtinFunctionInfos: List[BuiltinFunctionInfo] = {
    ...
    List(
      ...
      BuiltinFunctionInfo(LEQ_INT64, BELessEq, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        LEQ_DECIMAL,
        BELessEq,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(GEQ_INT64, BEGreaterEq, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        GEQ_DECIMAL,
        BEGreaterEq,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(
        ...
        implicitParameters = List(TParty),
        minVersion = partyOrdering),
      BuiltinFunctionInfo(LESS_INT64, BELess, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        LESS_DECIMAL,
        BELess,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(
        ...
        implicitParameters = List(TParty),
        minVersion = partyOrdering),
      BuiltinFunctionInfo(GREATER_INT64, BEGreater, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        GREATER_DECIMAL,
        BEGreater,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(GEQ_DATE, BEGreaterEq, implicitParameters = List(TDate)),
      BuiltinFunctionInfo(LEQ_DATE, BELessEq, implicitParameters = List(TDate)),
      BuiltinFunctionInfo(LESS_DATE, BELess, implicitParameters = List(TDate)),
      ...
      BuiltinFunctionInfo(GREATER_DATE, BEGreater, implicitParameters = List(TDate)),
