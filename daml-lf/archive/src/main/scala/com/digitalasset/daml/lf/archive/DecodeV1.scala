...
private[lf] object DecodeV1 {
  ...
  val builtinFunctionInfos: List[BuiltinFunctionInfo] = {
    ...
    List(
      ...
      BuiltinFunctionInfo(LEQ_INT64, BLessEq, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        LEQ_DECIMAL,
        BLessEq,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(LEQ_TEXT, BLessEq, implicitParameters = List(TText)),
      BuiltinFunctionInfo(LEQ_TIMESTAMP, BLessEq, implicitParameters = List(TTimestamp)),
      BuiltinFunctionInfo(
        LEQ_PARTY,
        BLessEq,
        implicitParameters = List(TParty),
        minVersion = partyOrdering),
      BuiltinFunctionInfo(GEQ_INT64, BGreaterEq, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        GEQ_DECIMAL,
        BGreaterEq,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(LESS_TEXT, BLess, implicitParameters = List(TText)),
      BuiltinFunctionInfo(LESS_TIMESTAMP, BLess, implicitParameters = List(TTimestamp)),
      BuiltinFunctionInfo(
        LESS_PARTY,
        BLess,
        implicitParameters = List(TParty),
        minVersion = partyOrdering),
      BuiltinFunctionInfo(GREATER_INT64, BGreater, implicitParameters = List(TInt64)),
      BuiltinFunctionInfo(
        GREATER_DECIMAL,
        BGreater,
        maxVersion = Some(numeric),
      ...
      BuiltinFunctionInfo(GREATER_TEXT, BGreater, implicitParameters = List(TText)),
      BuiltinFunctionInfo(GREATER_TIMESTAMP, BGreater, implicitParameters = List(TTimestamp)),
      BuiltinFunctionInfo(
        GREATER_PARTY,
        BGreater,
        implicitParameters = List(TParty),
