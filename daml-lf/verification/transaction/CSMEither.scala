...
object CSMEitherDef {
  ...
  def sameState[T](s1: State, s2: Either[T, State]): Boolean = {
    ...
    _ == (sameStack(s1, s2) && sameGlobalKeys(s1, s2) && sameActiveState(s1, s2) && sameLocallyCreated(s1, s2) && sameConsumed(s1, s2))
  )
  ...
  }.ensuring(_ == (sameLocallyCreatedThisTimeline(s1, s2) && sameConsumedBy(s1, s2) && sameLocalKeys(s1, s2)))
  ...
  def sameLocallyCreatedThisTimeline[T](s1: State, s2: Either[T, State]): Boolean = {
    s2.forall((s: State) => s1.activeState.locallyCreatedThisTimeline == s.activeState.locallyCreatedThisTimeline)
  }
...
object CSMEither {
  ...
  @pure
  @opaque
  def sameStackTransitivity[U, V, W](s1: Either[U, State], s2: Either[V, State], s3: Either[W, State]): Unit = {
    require(sameStack(s1, s2))
    require(sameStack(s2, s3))
    require(propagatesError(s2, s3))
  ...
  @pure
  @opaque
  def sameGlobalKeysTransitivity[V, W](s1: State, s2: Either[V, State], s3: Either[W, State]): Unit = {
  ...
  @pure
  @opaque
  def sameGlobalKeysTransitivity[U, V, W](s1: Either[U, State], s2: Either[V, State], s3: Either[W, State]): Unit = {
    require(sameGlobalKeys(s1, s2))
    require(sameGlobalKeys(s2, s3))
    require(propagatesError(s2, s3))
  ...
  @pure
  @opaque
  def sameLocallyCreatedTransitivity[V, W](s1: State, s2: Either[V, State], s3: Either[W, State]): Unit = {
  ...
  @pure
  @opaque
  def sameConsumedTransitivity[V, W](s1: State, s2: Either[V, State], s3: Either[W, State]): Unit = {
  ...
  @pure
  @opaque
  def propagatesErrorTransitivity[T, V](s1: Either[T, V], s2: Either[T, V], s3: Either[T, V]): Unit = {
  ...
  @pure
  @opaque
  def propagatesSameErrorTransitivity[T, V](s1: Either[T, V], s2: Either[T, V], s3: Either[T, V]): Unit = {
