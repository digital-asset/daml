...
object TransactionTreeChecksDef {
  ...
  @pure
  @opaque
  def unboundFun(s: (Set[ContractId], Set[ContractId], Boolean), p: (NodeId, Node)): (Set[ContractId], Set[ContractId], Boolean) = {
    ...
    p._2 match {
      ...
      case Node.Exercise(targetCoid, _, _, None(), _) => (s._1 + targetCoid, s._2, s._3 && !s._2.contains(targetCoid))
      case Node.Exercise(targetCoid, _, _, _, _) => (s._1, s._2 + targetCoid, s._3 && !s._1.contains(targetCoid))
   ...
   */
  @pure
  def scanUnbound(tr: Tree[(NodeId, Node)]): List[((Set[ContractId], Set[ContractId], Boolean), (NodeId, Node), TraversalDirection)] = {
  ...
  @pure
  @opaque
  def buildLC(s: (Set[ContractId], Set[ContractId], Boolean), p: (NodeId, Node)): (Set[ContractId], Set[ContractId], Boolean) = {
    SetProperties.subsetOfReflexivity(s._1)
    SetProperties.subsetOfReflexivity(s._2)
    p._2 match {
    ...
    res => s._1.subsetOf(res._1) && s._2.subsetOf(res._2) && (!s._3 ==> !res._3)
  )
   ...
   */
  @pure
  def scanLC(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed: Set[ContractId], defined: Boolean): List[((Set[ContractId], Set[ContractId], Boolean), (NodeId, Node), TraversalDirection)] = {
   ...
   */
  @pure
  def traverseLC(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed: Set[ContractId], defined: Boolean): (Set[ContractId], Set[ContractId], Boolean) = {
...
object TransactionTreeChecks {
  ...
  def scanTraverseUnboundProp(tr: Tree[(NodeId, Node)], i: BigInt): Unit = {
    ...
    val p2: ((Set[ContractId], Set[ContractId], Boolean)) => Boolean = (s1, s2, b) => b ==> s1.disjoint(s2)
  ...
  def traverseUnboundProp(tr: Tree[(NodeId, Node)]): Unit = {
    ...
    if (tr.size > 0) {
      ...
      scanIndexingState(tr, (Set.empty[ContractId], Set.empty[ContractId], true), unboundFun, (z, t) => z, 0)
    }
    else {
      SetProperties.disjointEmpty(Set.empty[ContractId])
    }
  ...
  def scanTraverseUnboundPropDown(tr: Tree[(NodeId, Node)], i: BigInt): Unit = {
    ...
    scanUnbound(tr)(i)._2._2 match {
      case Node.Create(coid, opt) => (traverseUnbound(tr)._1.contains(coid) == !opt.isDefined) && (traverseUnbound(tr)._2.contains(coid) == opt.isDefined)
      case exe: Node.Exercise => (traverseUnbound(tr)._1.contains(exe.targetCoid) == !exe.gkeyOpt.isDefined) && (traverseUnbound(tr)._2.contains(exe.targetCoid) == exe.gkeyOpt.isDefined)
      case _ => true
    }
  )
  ...
  @pure
  @opaque
  def scanTraverseLCProp(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed: Set[ContractId], defined: Boolean, i: BigInt): Unit = {
    ...
    if (!p(tr.scan((lc, consumed, defined), buildLC, (z, t) => z)(i)._1)) {
      ...
      SetProperties.subsetOfReflexivity(tr.scan((lc, consumed, defined), buildLC, (z, t) => z)(j)._1._1)
      SetProperties.subsetOfReflexivity(tr.scan((lc, consumed, defined), buildLC, (z, t) => z)(j)._1._2)
      if (j == 2 * tr.size - 1) {
        scanIndexingState(tr, (lc, consumed, defined), buildLC, (z, t) => z, 0)
      }
      else {
        scanIndexingState(tr, (lc, consumed, defined), buildLC, (z, t) => z, j + 1)
        SetProperties.subsetOfTransitivity(scanLC(tr, lc, consumed, defined)(j)._1._1, scanLC(tr, lc, consumed, defined)(j + 1)._1._1, traverseLC(tr, lc, consumed, defined)._1)
        SetProperties.subsetOfTransitivity(scanLC(tr, lc, consumed, defined)(j)._1._2, scanLC(tr, lc, consumed, defined)(j + 1)._1._2, traverseLC(tr, lc, consumed, defined)._2)
      }
    }

  }.ensuring(
    scanLC(tr, lc, consumed, defined)(i)._1._1.subsetOf(traverseLC(tr, lc, consumed, defined)._1) &&
      scanLC(tr, lc, consumed, defined)(i)._1._2.subsetOf(traverseLC(tr, lc, consumed, defined)._2) &&
  ...
  @pure
  @opaque
  def scanTraverseLCPropDown(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed: Set[ContractId], defined: Boolean, i: BigInt): Unit = {
    require(i < 2 * tr.size)
    require(0 <= i)
    ...
    if (i == 2 * tr.size - 1) {
      ...
      p._2 match {
        case Node.Create(coid, _) =>
          SetProperties.subsetOfContains(scanLC(tr, lc, consumed, defined)(i + 1)._1._1, traverseLC(tr, lc, consumed, defined)._1, coid)
        case exe: Node.Exercise if exe.consuming =>
          SetProperties.subsetOfContains(scanLC(tr, lc, consumed, defined)(i + 1)._1._2, traverseLC(tr, lc, consumed, defined)._2, exe.targetCoid)
        case _ => Trivial()
      }
    }
  }.ensuring(
  ...
  @pure
  @opaque
  def scanLCSubsetOf(tr: Tree[(NodeId, Node)], lc1: Set[ContractId], consumed1: Set[ContractId], defined1: Boolean,
                     lc2: Set[ContractId], consumed2: Set[ContractId], defined2: Boolean, i: BigInt): Unit = {
    decreases(i)
    require(i < 2 * tr.size)
    require(0 <= i)
    ...
    if (i == 0) {
      ...
      scanIndexingNode(tr, (lc1, consumed1, defined1), (lc2, consumed2, defined2), buildLC, (z, t) => z, buildLC, (z, t) => z, i - 1)
      ...
      n._2 match {
        ...
        case exe: Node.Exercise if exe.consuming => SetProperties.subsetOfIncl(s12, s22, exe.targetCoid)
        case _ => Trivial()
      }
    }
    ...
    scanLC(tr, lc1, consumed1, defined1)(i)._1._1.subsetOf(scanLC(tr, lc2, consumed2, defined2)(i)._1._1) &&
      scanLC(tr, lc1, consumed1, defined1)(i)._1._2.subsetOf(scanLC(tr, lc2, consumed2, defined2)(i)._1._2) &&
      (scanLC(tr, lc2, consumed2, defined2)(i)._1._3 ==> scanLC(tr, lc1, consumed1, defined1)(i)._1._3)
  )
  ...
  @pure
  @opaque
  def traverseLCSubsetOf(tr: Tree[(NodeId, Node)], lc1: Set[ContractId], consumed1: Set[ContractId], defined1: Boolean,
                         lc2: Set[ContractId], consumed2: Set[ContractId], defined2: Boolean): Unit = {
    require(lc1.subsetOf(lc2))
    require(consumed1.subsetOf(consumed2))
    require(defined2 ==> defined1)
    ...
    if (tr.size == 0) {
      ...
      scanIndexingNode(tr, (lc1, consumed1, defined1), (lc2, consumed2, defined2), buildLC, (z, t) => z, buildLC, (z, t) => z, 2 * tr.size - 1)
      unfold(buildLC((s11, s12, b13), n))
      unfold(buildLC((s21, s22, b23), n))
    ...
    traverseLC(tr, lc1, consumed1, defined1)._1.subsetOf(traverseLC(tr, lc2, consumed2, defined2)._1) &&
      traverseLC(tr, lc1, consumed1, defined1)._2.subsetOf(traverseLC(tr, lc2, consumed2, defined2)._2) &&
   ...
   */
  def scanLCExtractInitLC(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed1: Set[ContractId],
                          consumed2: Set[ContractId], defined: Boolean, i: BigInt): Unit = {
    decreases(i)
    require(i < 2 * tr.size)
    require(0 <= i)
    ...
    if (i == 0) {
      ...
      scanIndexingNode(tr, (lc, consumed1, defined), (Set.empty[ContractId], consumed2, defined), buildLC, (z, t) => z, buildLC, (z, t) => z, i - 1)
   ...
   * @param defined   Indicates whether there is already an error or not.
   */
  def traverseLCExtractInitLC(tr: Tree[(NodeId, Node)], lc: Set[ContractId], consumed1: Set[ContractId],
                              consumed2: Set[ContractId], defined: Boolean): Unit = {
    ...
    if (tr.size > 0) {
      ...
      scanIndexingNode(tr, (lc, consumed1, defined), (Set.empty[ContractId], consumed2, defined), buildLC, (z, t) => z, buildLC, (z, t) => z, 2 * tr.size - 1)
   ...
   * @param i         The step number of the intermediate set we are looking at.
   */
  def scanLCExtractInitConsumed(tr: Tree[(NodeId, Node)], lc1: Set[ContractId], lc2: Set[ContractId], consumed: Set[ContractId],
                                defined: Boolean, i: BigInt): Unit = {
    decreases(i)
    require(i < 2 * tr.size)
    require(0 <= i)
    ...
    if (i == 0) {
      ...
      scanIndexingNode(tr, (lc1, consumed, defined), (lc2, Set.empty[ContractId], defined), buildLC, (z, t) => z, buildLC, (z, t) => z, i - 1)
      ...
      if (dir == TraversalDirection.Down) {
        ...
        n._2 match {
          case exe: Node.Exercise if exe.consuming =>
            ...
            SetProperties.unionEqualsRight(se._2, Set(exe.targetCoid) ++ consumed, consumed ++ Set(exe.targetCoid))
            SetProperties.equalsTransitivity(
   ...
   * @param defined   Indicates whether there is already an error or not.
   */
  def traverseLCExtractInitConsumed(tr: Tree[(NodeId, Node)], lc1: Set[ContractId], lc2: Set[ContractId], consumed: Set[ContractId],
                                    defined: Boolean): Unit = {
    ...
    if (tr.size > 0) {
      ...
      scanIndexingNode(tr, (lc1, consumed, defined), (lc2, Set.empty[ContractId], defined), buildLC, (z, t) => z, buildLC, (z, t) => z, 2 * tr.size - 1)
  ...
  @pure
  @opaque
  def scanTransactionLC(tr: Tree[(NodeId, Node)], init: Either[KeyInputError, State], defined: Boolean, i: BigInt): Unit = {
    ...
    (scanTransaction(tr, init)(i)._1.get.locallyCreated == scanLC(tr, init.get.locallyCreated, init.get.consumed, defined)(i)._1._1) &&
      (scanTransaction(tr, init)(i)._1.get.consumed == scanLC(tr, init.get.locallyCreated, init.get.consumed, defined)(i)._1._2)
  )
  ...
  @pure
  @opaque
  def traverseTransactionLC(tr: Tree[(NodeId, Node)], init: Either[KeyInputError, State], defined: Boolean): Unit = {
    ...
    if (tr.size == 0) {
      ...
      scanIndexingNode(tr, init, initTr, traverseInFun, traverseOutFun, buildLC, (z, t) => z, 2 * tr.size - 1)
    ...
    (traverseTransaction(tr, init).get.locallyCreated == traverseLC(tr, init.get.locallyCreated, init.get.consumed, defined)._1) &&
      (traverseTransaction(tr, init).get.consumed == traverseLC(tr, init.get.locallyCreated, init.get.consumed, defined)._2)
  )
