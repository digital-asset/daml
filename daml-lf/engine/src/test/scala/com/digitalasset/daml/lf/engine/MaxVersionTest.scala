...
package com.daml.lf.engine.MaxVersionTest
...
final class MaxVersionTest
  ...
  "MaxVersionTest" - {
    "can upload an LF 1.15 package and use it in a transaction" in {
      for {
