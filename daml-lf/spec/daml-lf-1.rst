...
::
  ...
  Big-step evaluation      │ e  ⇓  r  │
    ...
    —————————————————————————————————————————————————————————————————————— EvExpUpExercise
      ...
      e₁  ⇓  Err t
    —————————————————————————————————————————————————————————————————————— EvExpUpExceriseWithoutActorsErr1
      'exercise_without_actors' @Mod:T Ch e₁ e₂  ⇓  Err t

      e₁  ⇓  Ok v₁
      e₂  ⇓  Err t
    —————————————————————————————————————————————————————————————————————— EvExpUpExceriseWithoutActorsErr2
      'exercise_without_actors' @Mod:T Ch e₁ e₂  ⇓  Err t
...
Note that the rules are designed such that for every expression,
at most one rule applies. Results are deterministic.

This semantics does not require nor preclude the cacheing or
memoization of evaluation results for top-level values, or for any
