          ...
          module PositiveCase_InterfaceMethodShouldBeProperType {
            ...
            template (this : T) =  {
              ...
              choice Ch (self) (i : Unit) : Unit
                  ...
                  to upure @Unit ();
              implements Mod:I {
                view = "PositiveCaseProperType Mod:I T";
          ...
          module PositiveCase_ImplementsShouldOverrideAllMethods {
            ...
            template (this : T) =  {
              ...
              choice Ch (self) (i : Unit) : Unit
                  ...
                  to upure @Unit ();
              implements Mod:I {
                view = "PositiveCaseOverrideAllMethods Mod:I T";
              };
            };
          }
          ...
          module PositiveCase_ImplementsShouldOverrideOnlyMethods {
            ...
            template (this : T) =  {
              ...
              choice Ch (self) (i : Unit) : Unit
                  ...
                  to upure @Unit ();
              implements Mod:I {
                view = "PositiveCaseOverrideOnlyMethods Mod:I T";
                method getParties =
      ...
      val pkg =
        p"""
          ...
          module PositiveTestCase_MissingRequiredInterface {
            ...
            template (this : T) =  {
              ...
              implements PositiveTestCase_MissingRequiredInterface:Y {
                view = "MissingRequiredInterface";
              };
           };
          }

          module PositiveTestCase_WrongInterfaceRequirement1 {
            interface (this : Y) = { viewtype Int64; };
            interface (this : Z) = { viewtype Bool; };
            interface (this : X) =  {
              viewtype Text;
          ...
          module PositiveTestCase_CircularInterfaceRequires {
            ...
            interface (this : Y) = { viewtype Bool; };
            interface (this : Z) = { viewtype Int64; };
          }
          ...
          module PositiveTestCase_ConflictingImplementsCoImplements {
            ...
            template (this: Hexagon) = {
              ...
              implements PositiveTestCase_ConflictingImplementsCoImplements:Polygon {
                view = "Hexagon implements Polygon";
                method getSides = 6;
              };
            };
            ...
            interface (this: Polygon) = {
              ...
              coimplements PositiveTestCase_ConflictingImplementsCoImplements:Hexagon {
                view = "Polygon coimplements Hexagon";
                method getSides = 6;
              };
            };
          }
