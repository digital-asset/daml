  ...
  "typeOf" should {
    ...
    "infers proper type for Update" in {
      val testCases = Table(
        ...
        E"λ (e₁: ContractId Mod:I) (e₂: Int64) (e₃: Mod:I → Bool) → (( exercise_by_interface_with_guard @Mod:I ChIface e₁ e₂ e₃ ))" ->
    ...
    "reject ill formed terms" in {
      ...
      val testCases = Table[Expr, PartialFunction[ValidationError, _]](
        ...
        E"λ (e₁: ContractId Mod:U) (e₂: Int64) (e₃: Mod:U → Bool) → ⸨ exercise_by_interface_with_guard @Mod:U ChIface e₁ e₂ e₃ ⸩" -> //
          {
            case EUnknownDefinition(
                  _,
        ...
        E"λ (e₁: ContractId Mod:I) (e₂: Int64) (e₃: Mod:I → Bool)  → ⸨ exercise_by_interface_with_guard @Mod:I Not e₁ e₂ e₃ ⸩" -> //
          {
            case EUnknownDefinition(
                  _,
        ...
        E"Λ (σ : ⋆).λ (e₁: ContractId Mod:I) (e₂: σ) (e₃: Mod:I → Bool) → ⸨ exercise_by_interface_with_guard @Mod:T ChIface e₁ e₂ e₃ ⸩" -> //
          { case _: ETypeMismatch => },
        E"Λ (σ : ⋆).λ (e₁: ContractId Mod:I) (e₂: Int64) (e₃: Mod:T → Bool) → ⸨ exercise_by_interface_with_guard @Mod:T ChIface e₁ e₂ e₃ ⸩" -> //
          { case _: ETypeMismatch => },
        E"Λ (σ : ⋆).λ (e₁: ContractId σ) (e₂: Int64) (e₃: Mod:I → Bool) → ⸨ exercise_by_interface_with_guard @Mod:I ChIface e₁ e₂ e₃ ⸩" -> //
          { case _: ETypeMismatch => },
        E"Λ (σ : ⋆).λ (e₁: ContractId Mod:I) (e₂: Int64) (e₃: σ) → ⸨ exercise_by_interface_with_guard @Mod:I ChIface e₁ e₂ e₃ ⸩" -> //
          { case _: ETypeMismatch => },
        E"Λ (σ : ⋆).λ (e₁: ContractId Mod:I) (e₂: Int64) (e₃: σ → Bool) → ⸨ exercise_by_interface_with_guard @Mod:I ChIface e₁ e₂ e₃ ⸩" -> //
          { case _: ETypeMismatch => },
        // This verifies that interface choice cannot be exercise by template
        E"""λ (e₁: ContractId Mod:Ti) (e: Mod:Ti) (e₂: Int64) (e₃: Mod:Ti → Bool) → ⸨ exercise_by_interface_with_guard @Mod:Ti ChIface e₁ e₂ e₃ ⸩""" -> //
          {
            case EUnknownDefinition(
                  _,
                  LookupError(Reference.Interface(_), Reference.InterfaceChoice(_, _)),
