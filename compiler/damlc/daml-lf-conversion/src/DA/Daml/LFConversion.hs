...
convertCtors env (Ctors name isNewtype tys [o@(Ctor ctor fldNames fldTys)])
  | isRecordCtor o
...
toCtors env t = Ctors (getName t) (tyConFlavour t == NewtypeFlavour) <$> mapM convTypeVar (tyConTyVars t) <*> cs
    where
