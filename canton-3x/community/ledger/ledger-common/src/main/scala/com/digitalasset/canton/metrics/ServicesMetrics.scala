...
class ServicesMetrics(
  ...
  object index {
    ...
    val listLfPackages: Timer = metricsFactory.timer(prefix :+ "list_lf_packages")
    @MetricDoc.FanInstanceTag
    val getLfArchive: Timer = metricsFactory.timer(prefix :+ "get_lf_archive")
    @MetricDoc.FanInstanceTag
    val packageEntries: Timer = metricsFactory.timer(prefix :+ "package_entries")
    @MetricDoc.FanInstanceTag
    val getLedgerConfiguration: Timer = metricsFactory.timer(prefix :+ "get_ledger_configuration")
    @MetricDoc.FanInstanceTag
    val currentLedgerEnd: Timer = metricsFactory.timer(prefix :+ "current_ledger_end")
    @MetricDoc.FanInstanceTag
    val latestPrunedOffsets: Timer = metricsFactory.timer(prefix :+ "latest_pruned_offsets")
    @MetricDoc.FanInstanceTag
    val getCompletions: Timer = metricsFactory.timer(prefix :+ "get_completions")
    @MetricDoc.FanInstanceTag
    val getCompletionsLimited: Timer = metricsFactory.timer(prefix :+ "get_completions_limited")
    @MetricDoc.FanInstanceTag
    val transactions: Timer = metricsFactory.timer(prefix :+ "transactions")
    @MetricDoc.FanInstanceTag
    val transactionTrees: Timer = metricsFactory.timer(prefix :+ "transaction_trees")
    @MetricDoc.FanInstanceTag
    val getTransactionById: Timer = metricsFactory.timer(prefix :+ "get_transaction_by_id")
    @MetricDoc.FanInstanceTag
    val getTransactionTreeById: Timer = metricsFactory.timer(prefix :+ "get_transaction_tree_by_id")
    @MetricDoc.FanInstanceTag
    val getActiveContracts: Timer = metricsFactory.timer(prefix :+ "get_active_contracts")
    @MetricDoc.FanInstanceTag
    val lookupActiveContract: Timer = metricsFactory.timer(prefix :+ "lookup_active_contract")
    @MetricDoc.FanInstanceTag
    val lookupContractStateWithoutDivulgence: Timer = metricsFactory.timer(
      prefix :+ "lookup_contract_state_without_divulgence"
    )
    @MetricDoc.FanInstanceTag
    val lookupContractKey: Timer = metricsFactory.timer(prefix :+ "lookup_contract_key")
    @MetricDoc.FanInstanceTag
    val getEventsByContractId: Timer = metricsFactory.timer(prefix :+ "get_events_by_contract_id")
    @MetricDoc.FanInstanceTag
    val getEventsByContractKey: Timer = metricsFactory.timer(prefix :+ "get_events_by_contract_key")
    @MetricDoc.FanInstanceTag
    val lookupMaximumLedgerTime: Timer =
      metricsFactory.timer(prefix :+ "lookup_maximum_ledger_time")
    @MetricDoc.FanInstanceTag
    val getParticipantId: Timer = metricsFactory.timer(prefix :+ "get_participant_id")
    @MetricDoc.FanInstanceTag
    val getParties: Timer = metricsFactory.timer(prefix :+ "get_parties")
    @MetricDoc.FanInstanceTag
    val listKnownParties: Timer = metricsFactory.timer(prefix :+ "list_known_parties")
    @MetricDoc.FanInstanceTag
    val partyEntries: Timer = metricsFactory.timer(prefix :+ "party_entries")
    @MetricDoc.FanInstanceTag
    val lookupConfiguration: Timer = metricsFactory.timer(prefix :+ "lookup_configuration")
    @MetricDoc.FanInstanceTag
    val configurationEntries: Timer = metricsFactory.timer(prefix :+ "configuration_entries")
    @MetricDoc.FanInstanceTag
    val prune: Timer = metricsFactory.timer(prefix :+ "prune")
    @MetricDoc.FanInstanceTag
    val getTransactionMetering: Timer = metricsFactory.timer(prefix :+ "get_transaction_metering")
    ...
    object InMemoryFanoutBuffer {
      ...
      val push: Timer = metricsFactory.timer(prefix :+ "push")
      ...
      val bufferSize: Histogram = metricsFactory.histogram(prefix :+ "size")
    }
    ...
    case class BufferedReader(streamName: String) {
      ...
      val fetchedTotal: Counter = metricsFactory.counter(prefix :+ "fetched_total")
      ...
      val fetchedBuffered: Counter = metricsFactory.counter(prefix :+ "fetched_buffered")
      ...
      val fetchTimer: Timer = metricsFactory.timer(prefix :+ "fetch")
      ...
      val conversion: Timer = metricsFactory.timer(prefix :+ "conversion")
      ...
      val slice: Timer = metricsFactory.timer(prefix :+ "slice")
      ...
      val sliceSize: Histogram = metricsFactory.histogram(prefix :+ "slice_size")
    }
  }
  ...
  object read {
    ...
    @MetricDoc.FanInstanceTag
    val stateUpdates: Timer = metricsFactory.timer(prefix :+ "state_updates")
    @MetricDoc.FanInstanceTag
    val getConnectedDomains: Timer = metricsFactory.timer(prefix :+ "get_connected_domains")
    @MetricDoc.FanInstanceTag
    val incompleteReassignmentOffsets: Timer =
      metricsFactory.timer(prefix :+ "incomplete_reassignment_offsets")
  }
  ...
  object write {
    ...
    @MetricDoc.FanInstanceTag
    val submitTransaction: Timer = metricsFactory.timer(prefix :+ "submit_transaction")
    @MetricDoc.FanInstanceTag
    val submitTransactionRunning: Counter =
      metricsFactory.counter(prefix :+ "submit_transaction_running")
    @MetricDoc.FanInstanceTag
    val submitReassignment: Timer = metricsFactory.timer(prefix :+ "submit_reassignment")
    @MetricDoc.FanInstanceTag
    val submitReassignmentRunning: Counter =
      metricsFactory.counter(prefix :+ "submit_reassignment_running")
    @MetricDoc.FanInstanceTag
    val uploadPackages: Timer = metricsFactory.timer(prefix :+ "upload_packages")
    @MetricDoc.FanInstanceTag
