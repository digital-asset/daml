...
- Enter the following script:
  ...
  This rule defines a one-to-one mapping between scopes and Daml ledger claims,
  this is compatible with the default request templates that are built into the OAuth 2.0 middleware.

  For simplicity, this rule grants access to all requested claims to all users.
