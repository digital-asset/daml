...
The Building Applications section covers the elements that are used to create, extend, and test your Daml full-stack application (including APIs and script libraries) and the architectural best practices for bringing those elements together.  
