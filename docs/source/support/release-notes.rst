...
- **Contract keys**: We've added documentation for contract keys, a way of specifying a primary key for contracts. For information about how to use them, see :doc:`/daml/reference/contract-keys`.
