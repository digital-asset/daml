...
For details on how to upload a Daml archive to the ledger, see the :ref:`deploy documentation </deploying>`. The rest of this page will focus on how to import a Daml package in other Daml projects.
