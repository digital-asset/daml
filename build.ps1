...
bazel build `-`-experimental_execution_log_file ${ARTIFACT_DIRS}/build_execution_windows.log `-`-build_event_json_file ${ARTIFACT_DIRS}/build_event_windows.json //...

bazel shutdown

bazel test `-`-experimental_execution_log_file ${ARTIFACT_DIRS}/test_execution_windows.log `-`-build_event_json_file ${ARTIFACT_DIRS}/test_event_windows.json //...
